...
for tegn in tale:
    if tegn == " ":
        ...
        sentences+=1
    elif tegn in alfabet:
        alfabet[tegn]+=1

print("Ord: ", words)
print("Setninger: ", sentences)

letters = sorted(alfabet.items(), key = lambda x:x[1], reverse = True)
print(letters)
